      ...
      <section class="practice-grid" aria-label="进入练习">
        <article class="entry-card entry-card--primary">
          ...
          <div class="entry-card__body">
            ...
            <p>{{ knowledgePointLabel }} · 预计 {{ context.nextAction.estimatedMinutes }} 分钟</p>
          </div>
...
const context = computed(() => contextStore.data ?? {
  ...
  nextAction: { title: '查看当前学习任务', knowledgePointId: '当前知识点', knowledgePointName: null, estimatedMinutes: 0, type: 'NONE' },
})
...
const knowledgePointLabel = computed(() => displayKnowledgePoint(context.value.nextAction.knowledgePointId, context.value.nextAction.knowledgePointName))
